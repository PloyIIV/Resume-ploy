import sentpayScreenshot from "../assets/image/SendPay 1.png"
import sentpay2 from "../assets/image/emojione_e-mail.png"
import beats from "../assets/image/Screenshot (162) 1.png"
import beatsScreenshot from "../assets/image/Edtech 1.png"
import eCommerseScreenshot from "../assets/image/e-commerce 1 1.png"
            ...
            <div className="w-4/5  flex items-center flex-col mt-10">
                ...
                <div className="flex flex-col lg:flex-row mt-5 items-center justify-center">
                    ...
                    <div className="w-[300px] h-[230px] bg-white rounded-xl shadow-2xl m-8 flex flex-col relative hover:scale-105">
                        ...
                        <img className="absolute bottom-2 right-2 w-5/6" src={sentpayScreenshot} />
                    </div>
                    ...
                    <div className="w-[300px] h-[230px] bg-white rounded-xl shadow-2xl m-8 flex flex-col relative hover:scale-105">
                        ...
                        <img className="absolute bottom-2 right-2 w-5/6" src={eCommerseScreenshot} />
                    </div>
                    ...
                    <div className="w-[300px] h-[230px] bg-white rounded-xl shadow-2xl m-8 flex flex-col relative hover:scale-105">
                        ...
                        <img className="absolute bottom-2 right-2 w-5/6" src={beatsScreenshot} />
                    </div>
                </div>
            </div>
        </div>
